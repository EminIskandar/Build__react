...
//img
import icon1 from 'img/icon/best_icon1.png'
import icon2 from 'img/icon/best_icon2.png'
import icon3 from 'img/icon/best_icon3.png'
import icon4 from 'img/icon/best_icon4.png'
